...
export default function BloodDonationFinder() {
  ...
  return (
    <div className="min-h-screen" style={{
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-4">
          ...
          <div className="space-y-5 lg:col-span-1">
                ...
                <div className="p-3 bg-white border rounded-2xl">
                  <button onClick={() => setShowBankMap(true)} className="w-full py-2 text-sm font-bold text-red-600 transition-colors border border-red-200 hover:bg-red-50 rounded-xl">
                    📍 Nearby Blood Banks
                  </button>
                </div>
      ...
      <Messages />
      <BankMap open={showBankMap} onClose={() => setShowBankMap(false)} />
      {/* Footer */}
